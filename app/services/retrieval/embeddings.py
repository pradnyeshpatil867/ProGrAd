...
BATCH_SIZE = 50
_GEMINI_DIM = 3072
_FALLABCK_DIM = 768 # all-mpnet-base-v2
...
def _load_falback():
    ...
    logfire.info("Loading sentence-tranformers fallback (all-mpbet-base-v2, 768-dim).")
    return SentenceTransformer("all-mpbet-base-v2")
...
def _init():
    ...
    if gemini:
        ...
        _active_model = _load_falback()
        _model_type = "fallback"

def get_embedding_dim() -> int:
    """Return the vector dimension for active model. Call after _init()."""
    _init()
    return _GEMINI_DIM if _model_type == "gemini" else _FALLABCK_DIM 
